...
这台设备支持电力或使用 **<ItemLink id="ae2:crank" />** 驱动，适合初期资源处理。
...
对于末影水晶、陨石水晶和谐振水晶等高级资源，水晶种子的合成通常需要更复杂的材料组合，且单次合成只能获得一个种子。
...
晶体催生仓支持加速卡，并可叠加来自邻近催生器的生长加成，适合批量生产高纯水晶。
...
AECS 还为部分常见模组提供了对应的高纯水晶，实现材料层面的联动。
具体用途各不相同。
